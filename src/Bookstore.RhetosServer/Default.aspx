...
%>    </div>
    ...
    <table><tbody>
<%
    var installedPackages = Autofac.ResolutionExtensions.Resolve<Rhetos.Deployment.InstalledPackages>(Autofac.Integration.Wcf.AutofacServiceHostFactory.Container);
